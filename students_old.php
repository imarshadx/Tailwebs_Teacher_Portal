...
if (isset($_POST["delete_id"])) {
    ...
    if ($deleteResult) {
        echo '<br/><div class="alert alert-success"><strong>Student Record Deleted Successfully.</strong></div>';
    } else {
        echo '<br/><div class="alert alert-danger"><strong>Error Deleting Record: '.mysqli_error($db).'</strong></div>';
    }
}

if (isset($_POST["edit_id"]) && isset($_POST["name"]) && isset($_POST["subject"]) && isset($_POST["marks"])) {
